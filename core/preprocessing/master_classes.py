...
class settings(object):
    ...
    def __init__(self, application, base_dir):
        ...
        directories['output'] = Path(directories['base'], 'output')
        directories['outputF'] = Path(directories['output'], f'Ab_{application}_{timing['datetime']}')
    ...
    def create_output_directory(self, N, case_id):
        # Set name for the seperate output folders of different instances
        self.directories['outputFcase'] = Path(self.directories['outputF'], 'N=' + str(N) + '_' + str(case_id) + '/')

        # Create folder to save results
        createDirectory(self.directories['outputFcase'])

        return self.directories['outputFcase']
