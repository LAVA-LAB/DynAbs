...
class mdp(object):
    ...
    def writePRISM_specification(self, mode, problem_type):
        ...
        specfile = Path(self.setup.directories['outputFcase'], self.setup.mdp['filename'] + "_" + mode + ".pctl")
    ...
    def writePRISM_explicit(self, actions, partition, trans, problem_type, mode='estimate',
        ...
        PRISM_allfiles = Path(self.setup.directories['outputFcase'], self.setup.mdp['filename'] + "_" + mode + ".all")
        ...
        ### Write states file
        PRISM_statefile = Path(self.setup.directories['outputFcase'], self.setup.mdp['filename'] + "_" + mode + ".sta")
        ...
        ### Write label file
        PRISM_labelfile = Path(self.setup.directories['outputFcase'], self.setup.mdp['filename'] + "_" + mode + ".lab")
        ...
        PRISM_transitionfile = Path(self.setup.directories['outputFcase'], self.setup.mdp['filename'] + "_" + mode + ".tra")
